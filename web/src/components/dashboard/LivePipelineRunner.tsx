...
function MetricPill({ label, value, accent = 'neutral' }: { label: string; value: string; accent?: string }) {
  ...
  return (
    <div className="flex flex-col items-center gap-1 px-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.07]">
...
export default function LivePipelineRunner() {
  ...
  const run = useCallback(async () => {
    ...
    // Animate each step with a short delay
    ...
    try {
      ...
      // Notify other hooks (SmartInsights, AnalyticsOverview)
